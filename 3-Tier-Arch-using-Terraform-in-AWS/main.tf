...
module "networkLayer" {
  source                    = "./modules/networkLayer"
  vpc_id                    = module.networkLayer.vpc_id
  ...
  gateway_id                = module.networkLayer.gateway_id
  subnet_id                 = var.subnet_id
  id_app                    = module.appLayer.id_app
  ...
  alb_security_group        = module.networkLayer.alb_security_group
  app_security_group        = var.app_security_group

}

module "appLayer" {
  source             = "./modules/appLayer"
  image_id           = var.image_id
  instance_type      = var.instance_type
  app_security_group = module.networkLayer.app_security_group
...
module "dataLayer" {
  source               = "./modules/dataLayer"
  engine_name          = var.engine_name
  engine_version       = var.engine_version
  storage              = var.storage
  db_subnet_group_name = module.networkLayer.aws_db_subnet_group_main
  ...
  db_security_group    = module.networkLayer.db_security_group
